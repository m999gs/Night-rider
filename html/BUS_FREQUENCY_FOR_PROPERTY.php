...
cross join PROPERTY_LOCATION p WHERE (P.PID='.$pid.'  AND LATITUDE>p.property_lati-0.01950 AND 
LATITUDE <p.property_lati+0.01950 AND LONGITUDE>p.property_longi-0.001120 AND 
LONGITUDE<p.property_longi+0.001120)) BS inner join BUSES B on BS.STOP_ID=B.STOP_ID ORDER BY B.ARRIVAL_TIME) 
ORDER BY VAL)) t
